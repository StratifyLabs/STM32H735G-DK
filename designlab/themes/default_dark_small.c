...
extern const lv_font_t montserrat_r_11;
...
extern const lv_font_t montserrat_r_14;
extern const lv_font_t montserrat_r_14;
extern const lv_font_t montserrat_r_17;
extern const lv_font_t montserrat_r_11;
extern const lv_font_t montserrat_r_14;
extern const lv_font_t montserrat_r_17;
...
extern const lv_font_t montserrat_r_17;
extern const lv_font_t montserrat_r_14;
extern const lv_font_t sourcecode_r_4;
extern const lv_font_t sourcecode_r_6;
...
static const lv_style_const_prop_t h1_const_list[] = {
  ...
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 / 2 } },
...
static const lv_style_const_prop_t h2_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_20 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 / 2 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } }
};
...
static const lv_style_const_prop_t h3_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_17 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 / 2 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } }
};
...
static const lv_style_const_prop_t h4_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_14 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 / 2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 / 2 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } }
};
...
static const lv_style_const_prop_t text_font_small_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_11 } }
};
...
static const lv_style_const_prop_t btn_outline_default_const_list[] = {
  ...
  { .prop = LV_STYLE_BORDER_WIDTH, .value = { .num = 1 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 *2 - 1 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 *2 - 1 } }
};
...
static const lv_style_const_prop_t paragraph_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_12 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 } }
};
...
static const lv_style_const_prop_t form_const_list[] = {
  { .prop = LV_STYLE_PAD_ROW, .value = { .num = 4 *2 } },
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 4 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 4 *4 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 } }
};
...
static const lv_style_const_prop_t form_field_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_14 } },
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 4 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 4 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 *2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 *2 } },
  { .prop = LV_STYLE_BORDER_WIDTH, .value = { .num = 1 /2 } }
};
...
static const lv_style_const_prop_t form_switch_const_list[] = {
  ...
  { .prop = LV_STYLE_WIDTH, .value = { .num = 51 } },
  { .prop = LV_STYLE_HEIGHT, .value = { .num = 25 } }
};
...
static const lv_style_const_prop_t form_hint_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_11 } },
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 4 / 2 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 4 / 2 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 / 2 *2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 / 2 *2 } },
  { .prop = LV_STYLE_TEXT_COLOR, .value = { .color = LV_COLOR_MAKE(0x66,0x66,0x66)  } }
};
...
static const lv_style_const_prop_t form_dropdown_list_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_14 } },
  { .prop = LV_STYLE_BORDER_WIDTH, .value = { .num = 1 /2 } },
  { .prop = LV_STYLE_MAX_HEIGHT, .value = { .num = 200 } },
  { .prop = LV_STYLE_PAD_ROW, .value = { .num = 4 } },
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 4 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 4 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 *2 } },
...
static const lv_style_const_prop_t btn_lg_const_list[] = {
  ...
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 4 *2 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 4 *2 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 *2 *3/2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 *2 *3/2 } }
};
...
static const lv_style_const_prop_t badge_sm_const_list[] = {
  ...
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 4 *2 /2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 4 *2 /2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 / 2 *2 /2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 / 2 *2 /2 } }
};
...
static const lv_style_const_prop_t badge_lg_const_list[] = {
  ...
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 4 *2 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 4 *2 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 / 2 *2 *3/2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 / 2 *2 *3/2 } }
};
...
static const lv_style_const_prop_t screen_const_list[] = {
  ...
  { .prop = LV_STYLE_TEXT_COLOR, .value = { .color = LV_COLOR_MAKE(0xff,0xff,0xff)  } },
  { .prop = LV_STYLE_PAD_ROW, .value = { .num = 4 / 2 } },
  { .prop = LV_STYLE_PAD_COLUMN, .value = { .num = 4 / 2 } }
};
...
static const lv_style_const_prop_t scrollbar_const_list[] = {
  ...
  { .prop = LV_STYLE_RADIUS, .value = { .num = 0x7fff } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 1 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 1 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = 4 } },
  { .prop = LV_STYLE_HEIGHT, .value = { .num = 4 } },
...
static const lv_style_const_prop_t modal_content_enabled_const_list[] = {
  ...
  { .prop = LV_STYLE_TRANSLATE_Y, .value = { .num = 20 } },
  { .prop = LV_STYLE_TRANSITION, .value = { .ptr = (void*)&transition_delayed_slow } }
};
...
static const lv_style_const_prop_t card_const_list[] = {
  { .prop = LV_STYLE_RADIUS, .value = { .num = 3 *2 } },
  { .prop = LV_STYLE_BG_OPA, .value = { .num = 255 } },
  { .prop = LV_STYLE_BG_COLOR, .value = { .color = LV_COLOR_MAKE(0x22,0x22,0x22)  } },
...
static const lv_style_const_prop_t toast_top_right_const_list[] = {
  ...
  { .prop = LV_STYLE_X, .value = { .num = 16 * -1 } },
  { .prop = LV_STYLE_Y, .value = { .num = 16 } }
};
...
static const lv_style_const_prop_t toast_bottom_right_const_list[] = {
  ...
  { .prop = LV_STYLE_X, .value = { .num = 16 *-1 } },
  { .prop = LV_STYLE_Y, .value = { .num = 16 *-1 } }
};
...
static const lv_style_const_prop_t hline_const_list[] = {
  { .prop = LV_STYLE_BG_COLOR, .value = { .color = LV_COLOR_MAKE(0x66,0x66,0x66)  } },
  { .prop = LV_STYLE_BG_OPA, .value = { .num = 255 } },
  { .prop = LV_STYLE_HEIGHT, .value = { .num = 0 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } }
};
...
static const lv_style_const_prop_t padding_tiny_const_list[] = {
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 4 / 3 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 4 / 3 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 4 / 3 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 4 / 3 } }
};
...
static const lv_style_const_prop_t outline_border_secondary_const_list[] = {
  ...
  { .prop = LV_STYLE_OUTLINE_WIDTH, .value = { .num = 1 } },
  { .prop = LV_STYLE_OUTLINE_PAD, .value = { .num = 1 } },
...
static const lv_style_const_prop_t grow_const_list[] = {
  { .prop = LV_STYLE_TRANSFORM_WIDTH, .value = { .num = 1 } },
  { .prop = LV_STYLE_TRANSFORM_HEIGHT, .value = { .num = 1 } }
};
...
static const lv_style_const_prop_t arc_indicator_const_list[] = {
  ...
  { .prop = LV_STYLE_ARC_WIDTH, .value = { .num = 6 } },
...
static const lv_style_const_prop_t line_const_list[] = {
  { .prop = LV_STYLE_LINE_WIDTH, .value = { .num = 0 } },
...
static const lv_style_const_prop_t colorwheel_main_const_list[] = {
  { .prop = LV_STYLE_ARC_WIDTH, .value = { .num = 8 } }
};
...
static const lvgl_api_style_descriptor_t default_dark_small_style_descriptor_list[] = {
...
void default_dark_small_apply_callback(lv_theme_t * theme, lv_obj_t * object){
...
const lvgl_api_style_descriptor_t * default_dark_small_get_style_callback(int offset){
  const size_t size = sizeof(default_dark_small_style_descriptor_list) / sizeof(lvgl_api_style_descriptor_t);
  if(offset < size){
    return &(default_dark_small_style_descriptor_list[offset]);
  }
  return NULL;
}

lv_theme_t themes_default_dark_small = {
  .apply_cb = default_dark_small_apply_callback,
  .parent = NULL,
  .user_data = (void*)default_dark_small_get_style_callback,
  .disp = NULL,
  .color_primary = 0,
  .color_secondary = 0,
  .font_small = &montserrat_r_11,
  .font_normal = &montserrat_r_12,
  .font_large = &montserrat_r_14,
  .flags = 0
};

lv_theme_t * themes_default_dark_small_initialize(lv_disp_t * disp, lv_theme_t * parent){
  themes_default_dark_small.disp = disp;
  themes_default_dark_small.parent = parent;
  return &themes_default_dark_small;
}
